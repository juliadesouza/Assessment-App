      ...
      return Column(
          ...
          children: [
              Container(
                ...
                child: Text(widget.question.statement, textAlign: TextAlign.justify, style: const TextStyle(fontSize: 20),)
              ),
              if (widget.question.type == QuestionType.multipleChoice) 
                ...
                child: Container(
                  ...
                  decoration: BoxDecoration(border: Border.all(color: kGrey, width: 2)),
                  child: TextFormField(
                        controller: textController,
                        maxLines: null,
                        expands: true,
                        onChanged:(String? value) {
                          BlocProvider.of<AssessmentBloc>(context).add(RegisterAnswer(widget.question.number, textController.text));
                        },
